            ...
            <main className="p-6 sm:p-10 space-y-6">
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div className="flex items-center p-6 bg-white shadow rounded-lg">
                        ...
                        <div>
                            <span className="block text-2xl font-bold">62000</span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            <span className="block text-2xl font-bold">68000</span>
                            <span className="block text-gray-500">Total Expense</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                            ...
                            <span className="block text-gray-500">Total Visitors</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
